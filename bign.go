...
var (
    ErrAdata              = errors.New("bign: invalid adata")
    ErrPrivateKey         = errors.New("bign: invalid PrivateKey")
    ErrParametersNotSetUp = errors.New("bign: parameters not set up before generating key")
    ErrInvalidASN1        = errors.New("bign: invalid ASN.1")
    ErrInvalidSignerOpts  = errors.New("bign: opts must be *SignerOpts")
)
